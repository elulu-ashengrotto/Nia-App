(function () {
  ...
  (function () {
    ...
    enterHandler = function () {
      var i = this,
        ...
        src;
      src = i.dataset.src;
      i.dataset.src = "https://166bdd1bfa9446e7.demo.carrd.co/done";
  ...
  onvisible.add(".table-wrapper.style2", {
    style: "fade-down",
    speed: 1000,
    intensity: 5,
    threshold: 3,
  ...
  onvisible.add(".table-wrapper.style3", {
    style: "tilt-right",
    speed: 1000,
    intensity: 5,
    threshold: 3,
  ...
  onvisible.add(".container.style4", {
    style: "fade-up",
    speed: 1000,
    intensity: 5,
    threshold: 3,
